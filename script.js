...
eyeIcon.addEventListener("click",() => {
    passwordInput.type = passwordInput.type ==="password"? "text" : "password";///เปลี่ยนจาก text to password , pasword to text
    eyeIcon.className =`fa-solid fa-eye${passwordInput.type === "password"? "" : "-slash"}`;//เปลี่ยน icon เมื่อกด icon
});
